...
public class userInfo {
    ...
    private String name,college,email,password,codeforces,hackerrank;

    public userInfo(String name, String college, String email, String password, String codeforces, String hackerrank) {
        this.name = name;
